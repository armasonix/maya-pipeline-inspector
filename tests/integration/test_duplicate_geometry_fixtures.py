"""Fixture-driven integration tests for duplicate geometry detection."""
...
DUPLICATE_GEOMETRY_FIXTURE_CASES = ("duplicate_geometry_twins",)
...
@pytest.mark.parametrize("fixture_stem", DUPLICATE_GEOMETRY_FIXTURE_CASES)
def test_duplicate_geometry_fixture_profiles(fixture_stem: str) -> None:

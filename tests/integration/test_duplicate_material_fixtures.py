"""Fixture-driven integration tests for duplicate material and texture detection."""
...
DUPLICATE_FIXTURE_CASES = ("duplicate_material_twins",)
...
@pytest.mark.parametrize("fixture_stem", DUPLICATE_FIXTURE_CASES)
def test_duplicate_material_fixture_profiles(fixture_stem: str) -> None:

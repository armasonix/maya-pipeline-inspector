"""Settings tab model for the Maya Pipeline Inspector panel."""
...
SETTINGS_BASIC_TAB_OBJECT_NAME = "pipelineInspectorSettingsBasicTab"
SETTINGS_ADVANCED_TAB_OBJECT_NAME = "pipelineInspectorSettingsAdvancedTab"

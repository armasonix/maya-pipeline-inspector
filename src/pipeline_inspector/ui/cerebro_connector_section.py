...
SETTINGS_CEREBRO_SECTION_OBJECT_NAME = "pipelineInspectorSettingsCerebroSection"
SETTINGS_CEREBRO_ENABLED_TOGGLE_OBJECT_NAME = "pipelineInspectorSettingsCerebroEnabledToggle"
SETTINGS_CEREBRO_DETAILS_OBJECT_NAME = "pipelineInspectorSettingsCerebroDetails"
SETTINGS_CEREBRO_SERVER_URL_INPUT_OBJECT_NAME = "pipelineInspectorSettingsCerebroServerUrlInput"
SETTINGS_CEREBRO_API_USER_INPUT_OBJECT_NAME = "pipelineInspectorSettingsCerebroApiUserInput"
SETTINGS_CEREBRO_API_PASSWORD_INPUT_OBJECT_NAME = (
    "pipelineInspectorSettingsCerebroApiPasswordInput"
)
SETTINGS_CEREBRO_PROJECT_INPUT_OBJECT_NAME = "pipelineInspectorSettingsCerebroProjectInput"
SETTINGS_CEREBRO_SERVICE_TOOLS_PATH_INPUT_OBJECT_NAME = (
    "pipelineInspectorSettingsCerebroServiceToolsPathInput"
)
...
def build_cerebro_connector_section(
    ...
    *,
    ...
    hint = qt_widgets.QLabel(
        "When enabled, Pipeline Inspector publishes validation summaries as Cerebro task notes. "

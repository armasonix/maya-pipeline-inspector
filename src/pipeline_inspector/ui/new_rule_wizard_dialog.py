...
from pipeline_inspector.core.rule_schema import SEVERITIES
...
NEW_RULE_WIZARD_DIALOG_OBJECT_NAME = "pipelineInspectorNewRuleWizardDialog"
NEW_RULE_WIZARD_TEMPLATE_COMBO_OBJECT_NAME = "pipelineInspectorNewRuleWizardTemplateCombo"
NEW_RULE_WIZARD_STATUS_LABEL_OBJECT_NAME = "pipelineInspectorNewRuleWizardStatusLabel"
NEW_RULE_WIZARD_OUTPUT_PATH_INPUT_OBJECT_NAME = (
    "pipelineInspectorNewRuleWizardOutputPathInput"
)
NEW_RULE_WIZARD_VALIDATE_BUTTON_OBJECT_NAME = (
    "pipelineInspectorNewRuleWizardValidateButton"
)
NEW_RULE_WIZARD_SAVE_BUTTON_OBJECT_NAME = "pipelineInspectorNewRuleWizardSaveButton"
NEW_RULE_WIZARD_EXPORT_STUDIO_BUTTON_OBJECT_NAME = (
    "pipelineInspectorNewRuleWizardExportStudioButton"
)
NEW_RULE_WIZARD_CLOSE_BUTTON_OBJECT_NAME = "pipelineInspectorNewRuleWizardCloseButton"
    ...
    def export_to_studio_extra_rules(self) -> Path | None:
        ...
        if not folder:
            self.set_status_message(
                "Configure pipeline.extra_rules_folder in pipeline_inspector_studio.json first."
            )
            return None
...
def _field_object_name(field_name: str) -> str:
    ...
    return f"pipelineInspectorNewRuleWizard{suffix}Input"

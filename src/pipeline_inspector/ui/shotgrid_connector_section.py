...
SETTINGS_SHOTGRID_SECTION_OBJECT_NAME = "pipelineInspectorSettingsShotGridSection"
SETTINGS_SHOTGRID_ENABLED_TOGGLE_OBJECT_NAME = "pipelineInspectorSettingsShotGridEnabledToggle"
SETTINGS_SHOTGRID_DETAILS_OBJECT_NAME = "pipelineInspectorSettingsShotGridDetails"
SETTINGS_SHOTGRID_SITE_URL_INPUT_OBJECT_NAME = "pipelineInspectorSettingsShotGridSiteUrlInput"
SETTINGS_SHOTGRID_SCRIPT_NAME_INPUT_OBJECT_NAME = (
    "pipelineInspectorSettingsShotGridScriptNameInput"
)
SETTINGS_SHOTGRID_API_KEY_INPUT_OBJECT_NAME = "pipelineInspectorSettingsShotGridApiKeyInput"
SETTINGS_SHOTGRID_PROJECT_INPUT_OBJECT_NAME = "pipelineInspectorSettingsShotGridProjectInput"
SETTINGS_SHOTGRID_ENTITY_TYPE_INPUT_OBJECT_NAME = (
    "pipelineInspectorSettingsShotGridEntityTypeInput"
)
    ...
    *,
    ...
    details_layout.addWidget(
        _build_shotgrid_field_row(
            ...
            placeholder="pipeline_inspector",
            on_changed=on_settings_changed,
        )
    )
    details_layout.addWidget(
    ...
    hint = qt_widgets.QLabel(
        "When enabled, Pipeline Inspector can publish validation summaries as ShotGrid "

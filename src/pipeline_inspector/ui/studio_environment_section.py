...
SETTINGS_STUDIO_ENVIRONMENT_SECTION_OBJECT_NAME = (
    "pipelineInspectorSettingsStudioEnvironmentSection"
)
SETTINGS_STUDIO_ENVIRONMENT_GRID_OBJECT_NAME = (
    "pipelineInspectorSettingsStudioEnvironmentGrid"
)
SETTINGS_STUDIO_ENVIRONMENT_LEFT_COLUMN_OBJECT_NAME = (
    "pipelineInspectorSettingsStudioEnvironmentLeftColumn"
)
SETTINGS_STUDIO_ENVIRONMENT_RIGHT_COLUMN_OBJECT_NAME = (
    "pipelineInspectorSettingsStudioEnvironmentRightColumn"
)
SETTINGS_TEXTURE_ROOT_INPUT_OBJECT_NAME = "pipelineInspectorSettingsTextureRootInput"
SETTINGS_ASSET_ROOT_INPUT_OBJECT_NAME = "pipelineInspectorSettingsAssetRootInput"
SETTINGS_CACHE_ROOT_INPUT_OBJECT_NAME = "pipelineInspectorSettingsCacheRootInput"
SETTINGS_RENDER_ROOT_INPUT_OBJECT_NAME = "pipelineInspectorSettingsRenderRootInput"
SETTINGS_VARIABLE_ALIASES_INPUT_OBJECT_NAME = (
    "pipelineInspectorSettingsVariableAliasesInput"
)
...
def build_studio_environment_section(
    ...
    *,
    ...
    intro = qt_widgets.QLabel(
        "Studio network path roots stored in pipeline_inspector_studio.json. "

...
SETTINGS_ADVANCED_SECTION_OBJECT_NAME = "pipelineInspectorSettingsAdvancedSection"
SETTINGS_EXTRA_RULE_PATHS_INPUT_OBJECT_NAME = (
    "pipelineInspectorSettingsExtraRulePathsInput"
)
SETTINGS_DEBUG_LOGGING_TOGGLE_OBJECT_NAME = "pipelineInspectorSettingsDebugLoggingToggle"
SETTINGS_MAX_ISSUES_INPUT_OBJECT_NAME = "pipelineInspectorSettingsMaxIssuesInput"
SETTINGS_MAYAPY_PATH_INPUT_OBJECT_NAME = "pipelineInspectorSettingsMayapyPathInput"
SETTINGS_RULE_EDITOR_BUTTON_OBJECT_NAME = "pipelineInspectorSettingsRuleEditorButton"
SETTINGS_BROWSE_RULES_BUTTON_OBJECT_NAME = SETTINGS_RULE_EDITOR_BUTTON_OBJECT_NAME
SETTINGS_NEW_RULE_WIZARD_BUTTON_OBJECT_NAME = "pipelineInspectorSettingsNewRuleWizardButton"
...
def build_advanced_settings_section(
    ...
    *,
    ...
    form.addRow(
        ...
        build_labeled_toggle_row(
            qt_widgets,
            "Enable verbose pipeline_inspector logging",
            debug_toggle,
            label_width=228,
        ),
    )

...
SETTINGS_TELEGRAM_SECTION_OBJECT_NAME = "pipelineInspectorSettingsTelegramSection"
SETTINGS_TELEGRAM_ENABLED_TOGGLE_OBJECT_NAME = "pipelineInspectorSettingsTelegramEnabledToggle"

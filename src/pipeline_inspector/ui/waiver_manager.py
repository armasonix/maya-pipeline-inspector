"""Waiver manager UI for the Maya Pipeline Inspector panel."""
...
from pipeline_inspector.core.waivers import WaiverRecord, waiver_status_label
from pipeline_inspector.ui.table_widgets import configure_read_only_table, make_read_only_item

WAIVER_MANAGER_OBJECT_NAME = "pipelineInspectorWaiverManager"
WAIVER_STATUS_LABEL_OBJECT_NAME = "pipelineInspectorWaiverStatusLabel"
WAIVER_TABLE_OBJECT_NAME = "pipelineInspectorWaiverTable"

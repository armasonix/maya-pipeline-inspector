"""Shared Qt table helpers for Maya Pipeline Inspector UI."""
...
def make_fix_queue_select_cell(
    ...
    *,
    ...
    if add_stretch is not None:
        add_stretch()
    cell._pipeline_inspector_select_button = checkbox
    return cell
...
def _find_fix_queue_select_button(cell_widget: Any) -> Any:
    stored = getattr(cell_widget, "_pipeline_inspector_select_button", None)

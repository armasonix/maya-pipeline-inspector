...
SETTINGS_DISCORD_SECTION_OBJECT_NAME = "shaderHealthInspectorSettingsDiscordSection"
SETTINGS_DISCORD_ENABLED_TOGGLE_OBJECT_NAME = "shaderHealthInspectorSettingsDiscordEnabledToggle"
SETTINGS_DISCORD_DETAILS_OBJECT_NAME = "shaderHealthInspectorSettingsDiscordDetails"
SETTINGS_DISCORD_WEBHOOK_URL_INPUT_OBJECT_NAME = (
    "shaderHealthInspectorSettingsDiscordWebhookUrlInput"
)
SETTINGS_DISCORD_NOTIFY_BLOCK_PUBLISH_CHECKBOX_OBJECT_NAME = (
    "shaderHealthInspectorSettingsDiscordNotifyBlockPublishCheckbox"
)
SETTINGS_DISCORD_NOTIFY_BLOCK_DEADLINE_CHECKBOX_OBJECT_NAME = (
    "shaderHealthInspectorSettingsDiscordNotifyBlockDeadlineCheckbox"
)
...
def build_discord_connector_section(
    ...
    *,
    ...
    hint = qt_widgets.QLabel(
        "When enabled, Shader Health can send validation summaries to Discord as embeds "

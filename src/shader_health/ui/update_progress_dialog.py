...
UPDATE_PROGRESS_DIALOG_OBJECT_NAME = "shaderHealthInspectorUpdateProgressDialog"
UPDATE_PROGRESS_TITLE_LABEL_OBJECT_NAME = "shaderHealthInspectorUpdateProgressTitleLabel"
UPDATE_PROGRESS_VERSION_LABEL_OBJECT_NAME = "shaderHealthInspectorUpdateProgressVersionLabel"
UPDATE_PROGRESS_STATUS_LABEL_OBJECT_NAME = "shaderHealthInspectorUpdateProgressStatusLabel"
UPDATE_PROGRESS_STEPS_WIDGET_OBJECT_NAME = "shaderHealthInspectorUpdateProgressStepsWidget"
UPDATE_PROGRESS_SPINNER_OBJECT_NAME = "shaderHealthInspectorUpdateProgressSpinner"
UPDATE_PROGRESS_CLOSE_BUTTON_OBJECT_NAME = "shaderHealthInspectorUpdateProgressCloseButton"

UPDATE_PROGRESS_STEP_LABEL_OBJECT_NAME_PREFIX = "shaderHealthInspectorUpdateProgressStepLabel"
UPDATE_PROGRESS_STEP_DESCRIPTION_OBJECT_NAME_PREFIX = (
    "shaderHealthInspectorUpdateProgressStepDescription"
)
...
DEFAULT_UPDATE_STEP_DESCRIPTIONS: tuple[str, ...] = (
    ...
    "Installing the update while preserving shader_health_studio.json and user.json.",
...
class UpdateProgressDialog:
    ...
    def build(
        ...
        *,
        ...
        title_text: str = "Shader Health Inspector — Check for Updates",
        status_message: str = "",

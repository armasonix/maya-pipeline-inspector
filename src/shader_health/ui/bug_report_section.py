...
SETTINGS_BUG_REPORT_SECTION_OBJECT_NAME = "shaderHealthInspectorSettingsBugReportSection"
SETTINGS_BUG_REPORT_ENABLED_TOGGLE_OBJECT_NAME = (
    "shaderHealthInspectorSettingsBugReportEnabledToggle"
)
SETTINGS_BUG_REPORT_DETAILS_OBJECT_NAME = "shaderHealthInspectorSettingsBugReportDetails"
SETTINGS_BUG_REPORT_RELAY_URL_INPUT_OBJECT_NAME = (
    "shaderHealthInspectorSettingsBugReportRelayUrlInput"
)
SETTINGS_BUG_REPORT_API_KEY_INPUT_OBJECT_NAME = (
    "shaderHealthInspectorSettingsBugReportApiKeyInput"
)
SETTINGS_BUG_REPORT_ALLOW_SCREENSHOT_CHECKBOX_OBJECT_NAME = (
    "shaderHealthInspectorSettingsBugReportAllowScreenshotCheckbox"
)
SETTINGS_BUG_REPORT_MAX_REPORTS_INPUT_OBJECT_NAME = (
    "shaderHealthInspectorSettingsBugReportMaxReportsInput"
)
SETTINGS_BUG_REPORT_PRIVACY_NOTICE_OBJECT_NAME = (
    "shaderHealthInspectorSettingsBugReportPrivacyNotice"
)

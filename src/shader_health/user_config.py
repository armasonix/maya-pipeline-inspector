...
USER_CONFIG_ENV_VAR = "SHADER_HEALTH_USER_CONFIG"
USER_CONFIG_DIRNAME = ".shader_health"
USER_CONFIG_FILENAME = "user.json"
DEFAULT_USER_DOCS_URL = "https://github.com/armasonix/maya-shader-health-inspector/wiki"
...
class UserPreferences:
    """Persistent per-user settings for Shader Health Inspector."""

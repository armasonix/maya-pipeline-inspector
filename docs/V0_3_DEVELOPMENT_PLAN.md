...
**GitHub tracking:** issues [#91–#110](https://github.com/armasonix/maya-pipeline-inspector/issues) (plan ids #071–#090).
...
| M17 Gates | #077–#079 | `manifest_diff_policy`, `pipeline_inspector gate`, publish preflight |
| M18 Apply | #080–#083 | ADR 0004, headless `apply-fixes` |
| M19 Resolution | #084–#086 | Texture dimension metadata, resolution budgets |
| M20 Polish | #087–#089 | Approved manifest UI shortcut, `pipeline_inspector manifest`, CI smoke |
...
| #081 | #104 | pipeline_inspector apply-fixes subcommand |
...
| #088 | #105 | Headless pipeline_inspector manifest CLI |
